...
*No tension description recorded.* — Run karpathy-wiki-conflicts to document this.
...
- Don't compose if the topic's `covers::` list is empty — check first and offer to run `karpathy-wiki-ingest` or `karpathy-wiki-topic-init` instead
