...
Run it before `karpathy-wiki-compose` to ensure tensions are surfaced in exports, and after major rounds of ingest when new sources likely challenged existing claims.
