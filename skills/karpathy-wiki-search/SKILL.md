...
grep -ril "keyword" /home/bcmcpher/Projects/claude/karpathy-wiki/atoms/

# Keyword in source summaries
grep -ril "keyword" /home/bcmcpher/Projects/claude/karpathy-wiki/sources/

# Find all atoms in a domain by tag
grep -rl "tags:.*deep-learning" /home/bcmcpher/Projects/claude/karpathy-wiki/atoms/

# Find all uses of a specific relationship
grep -r "extends:: \[\[" /home/bcmcpher/Projects/claude/karpathy-wiki/atoms/
```
